...
public final class SoundPlayer {
     ...
     */
    public final void playFile(final String filePath)
	    throws FileNotFoundException, HemeraSoundException {
	...
	try {
	    ...
	    throw new HemeraSoundException(
		    "Unable to open sound source data line.", e);
	}
	...
	while (audioDataBytesRead != -1) {
	    try {
		// Reads.
		audioDataBytesRead = audioInputStream.read(audioDataBuffer, 0,
		...
		throw new HemeraSoundException(
			"Error while reading sound file '" + filePath + "'.", e);
	    }
	}
