...
echo -e "Online documentation:\thttps://gitlab.com/bertrand-benoit/hemerais/wikis"
echo -e "Quick Start:\t\thttps://gitlab.com/bertrand-benoit/hemerais/wikis/Hemera:QuickStart"
echo -e "Troubleshooting:\thttps://gitlab.com/bertrand-benoit/hemerais/wikis/Troubleshooting"
echo -e "Request Help:\t\thttps://gitlab.com/bertrand-benoit/hemerais/issues"
